...
export default function Skyline(props: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <Container {...props}>
      <Element color="var(--gray-9)" speed={speed * 8} z={1}>
      ...
      <Element color="var(--gray-10)" speed={speed * 4} z={2}>
      ...
      <Element color="var(--gray-11)" speed={speed * 2} z={3}>
      ...
      <Element color="var(--gray-12)" speed={speed * 1} z={4}>
